...
#define PIN_SCL          	22//26//19//26//19 // v.1.1 большой разъём	// 22 // Старый вариант (разъём I2C)             	/*!< gpio number for I2C master clock */
#define PIN_SDA          	21//33//22//26//21//25 // v.1.1 большой разъём  // 21 // Старый вариант (разъём I2C)              	/*!< gpio number for I2C master data  */
